                                        ...
                                        <ul class="sclist">
                                            @foreach($category->subCategories as $scategory)
                                                <li><i class="fa fa-caret-right"></i>{{$scategory->name}}
                                                    <a href="{{route('admin.editcategory',['category_slug'=>$category->slug,'scategory->slug'=>$scategory->slug])}}"><i class="fa fa-edit slink"></i></a>
                                                    <a href="#"onclick="confirm('Are you sure,you want to delete this subcategory?') ||event.stopImmediatePropagation()" wire:click.prevent="deleteSubcategory({{$scategory->id}})"><i class="fa fa-times text-danger slink"></i></a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </td>
