                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div>
                                <a href="{{route('admin.homeslider')}}" class="btn btn-success pull-right">Edit slide</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateSlide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Product slug" class="form-control input-md" wire:model="subtitle"/>
                                </div>
                            </div>
                            <div class="form-group">
