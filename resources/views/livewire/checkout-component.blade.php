                    ...
                    <div class="col-md-12">
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    <label for="city">Postcode/Zip<span>*</span></label>
                                    <input type="number" name="city" value="" placeholder="your postal code"wire:model="s_zipcode">
					...
					<div class="summary-item payment-method">
						...
						<div class="wrap-address-billing">
                            ...
                            <p class="row-in-form">
                                ...
                                <input type="number" name="city" value="" placeholder="Card Number"wire:model="card_no">
                                @error('card_no')<span class="text-danger">{{$message}}</span>@enderror
                            </p>
                            <p class="row-in-form">
                                <label for="card-no">Expiry month:</label>
                                <input type="number" name="city" value="" placeholder="MM"wire:model="exp_month">
                                @error('exp_month')<span class="text-danger">{{$message}}</span>@enderror
                            </p>
                            <p class="row-in-form">
                                <label for="card-no">Expiry Year:</label>
                                <input type="number" name="city" value="" placeholder="YY"wire:model="exp_year">
						...
						<div class="choose-payment-methods">
							<label class="payment-method">
								...
								<span>Cash on deilevery</span>
								<span class="payment-desc">Order now Pay on Deilvery</span>
							</label>
							<label class="payment-method">
