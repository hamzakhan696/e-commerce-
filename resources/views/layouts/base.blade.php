...
{{--										ADMIN--}}
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency">
                                                ...
                                                <li class="menu-item">
                                                    <a title="Categories" href="{{route('admin.homecategories')}}">Manage Home Categories</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a title="Manage Home Slider " href="{{route('admin.homeslider')}}">Manage Home slider</a>
                                                <li class="menu-item">
                                                    <a title="Sale Seeting" href="{{route('admin.sale')}}">Sale Seeting</a>
                                                  </li>
                                                <li class="menu-item">
                                                ...
                                                <li class="menu-item">
                                                    <a title="Contact Message" href="{{route('admin.contact')}}">CONTACTS MESSSAGES</a>
                                                </li>
                                                <li class="menu-item">
...
@livewire('footer-component')
    ...
    <script src="https://cdn.tiny.cloud/1/bn61dlrxpw9rduk2phucaw5vzxsewdfrk6o4kpihox2tkwdl/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
